...
class UpdateUserRoleUseCaseTest {
    ...
    void userNotFound_throwsUserNotFoundException() {
        ...
        assertThatThrownBy(() -> useCase.execute(id, new UpdateUserRoleRequest(Role.ADMIN)))
    ...
    void validRequest_updatesRoleAndReturnsResponse() {
        ...
        UserResponse response = useCase.execute(id, new UpdateUserRoleRequest(Role.SUPERVISOR));
